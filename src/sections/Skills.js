			...
			<Container fluid = {true} className=" bg-light">
				...
				<Container >
					<Row xs={1} md={2}>
						<Col>
							<Card>
								<Card.Header><h5>Programming Languages</h5></Card.Header>
								<Card.Body>
									<Card.Text>
										<b>Expert</b>
						...
						<Col>
							<Card>
								<Card.Header><h5>Machine Learning</h5></Card.Header>
								<Card.Body>
									<Card.Text>
					...
					<Row xs={1} md={2}>
						<Col>
							<Card>
								<Card.Header><h5>Web/Mobile/Desktop Development</h5></Card.Header>
								<Card.Body>
									<Card.Text>
										<b>Web Frontend</b>
						...
						<Col>
							<Card>
								<Card.Header><h5>Miscellaneous</h5></Card.Header>
								<Card.Body>
									<Card.Text>
										<b>Databases</b>
					...
					<Row xs={1}>
						<Col>
							<Card>
								<Card.Header><h5>Achievements</h5></Card.Header>
								<Card.Body>
									<Card.Text>

						<p><b>JEE Advanced 2017 :- </b> All India Rank 1760 (1.3 million candidates)</p>
						<p><b>KVPY 2017 :- </b> All India Rank 232 (0.3 million candidates)</p>
						<p><b>Debating Speaker :- </b> Novice Finalist at SRCC annual debate</p>
						<p><b>Debating Adjudicator :- </b> Three breaks as an adjudicator (Classify as A-level)</p>
									</Card.Text>
								</Card.Body>
							</Card>
						</Col>
