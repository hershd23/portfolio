				...
				<Jumbotron className="bg-transparent jumbotron-fluid p-0">
					<Container fluid={true}>
							<Row className="justify-content-left py-5 px-4">
								<Col md={8} sm={12}>
	{ <h3 className="display-5 font-weight-light text-light">{props.pretitle}</h3> }
	{ <h1 className="display-2 font-weight-bolder text-light">{props.title}</h1> }
	{ <h3 className="display-5 font-weight-light text-light">{props.subTitle}</h3> }
	{ <h3 className="lead font-weight-light text-light">{props.text}</h3> }
								</Col>
							</Row>
					</Container>
				</Jumbotron>
